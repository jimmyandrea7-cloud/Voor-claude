  ...
  return (
    <Layout>
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        <h1 className="mt-4 font-serif text-4xl text-[#2A2420]">Privacy Policy</h1>
        <p className="mt-3 text-[13px] text-[#A79E92]">Last updated: 12 September 2026</p>

        <div className="mt-10 space-y-8 text-[14px] text-[#6B6259] leading-relaxed">
          <section>
            <h2 className="font-serif text-xl text-[#2A2420] mb-2">What we collect</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-[#2A2420] mb-2">How we use it</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl text-[#2A2420] mb-2">Who we share it with</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="font-serif text-xl text-[#2A2420] mb-2">Your choices</h2>
            <p>
              You can sign out at any time. To request a copy of your data or ask us to delete your account and
              associated scans, email <a href={`mailto:${CONTACT_EMAIL}`} className="underline text-[#2A2420]">{CONTACT_EMAIL}</a>.
              We handle deletion requests manually and will confirm once it's done.
            </p>
          </section>

          <section>
            <h2 className="font-serif text-xl text-[#2A2420] mb-2">Changes to this policy</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl text-[#2A2420] mb-2">Contact</h2>
            <p>
              Questions about this policy: <a href={`mailto:${CONTACT_EMAIL}`} className="underline text-[#2A2420]">{CONTACT_EMAIL}</a>.
            </p>
          </section>
        </div>
      </div>
